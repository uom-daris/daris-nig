...
public class SvcMBCPETVarCheck extends PluginService {
	...
	public void execute(XmlDoc.Element args, Inputs in, Outputs out, XmlWriter w) throws Throwable {
		...
		String diff = compareSetValues (executor(), studyCID, mbc, date, petDICOMMeta, ctDICOMMeta, petVisits, patientName, mbcPatientID, 
	...
	/**
	 * 
	 * @param mbc   The MBC FMP data base
	 * @param date  The date of the acquisition of interest
	 * @param petDICOMMeta
	 * @param ctDICOMMeta
	 * @param petVisits
	 * @param patientName
	 * @param mbcPatientID
	 * @param dataset  The citable ID of the DaRIS DataSet
	 * @return
	 * @throws Throwable
	 */
	private String compareSetValues (ServiceExecutor executor, String studyCID, MBCFMP mbc, Date date, XmlDoc.Element petDICOMMeta, XmlDoc.Element ctDICOMMeta, 
			ResultSet petVisits, String patientName, String mbcPatientID, String petCID, String ctCID) throws Throwable {
		...
		if (petCID!=null) { 
			...
			//System.out.println("DICOM injection time = " + startInjectionTimeDICOM2);
			// Acquisition Time
		...
		System.out.println("DICOM isBloodPol = " + isBloodPool);
			...
			*/
			...
			if (  (scanTypeFMP.contains("EARLY") && isBloodPool) ||
				...
				if (petCID!=null) {
					if (!startInjectionTimeFMP.isEmpty()) {
						...
						if (t.length!=3) {
							...
							// System.out.println("Start times : " + startTimeDICOM2 + " " + t2);
					...
					mbc.updateScanTime (mbcPatientID, date, scanTypeFMP, t2, true);
				...
				if (ctCID!=null) {
					...
					mbc.updateScanTime (mbcPatientID, date, scanTypeFMP, t2, false);
