 ...
 * R-Subject:nig-daris:pssd-animal-disease/disease Once the migration is complete, the human-mri-simple Method will only
...
public class SvcRSubjectPathologyMigrate extends PluginService {
	...
	public String description() {
		return "Specialized service to migrate R-Subject:hfi.pssd/human.subject/pathology to Subject:nig-daris:pssd-animal-disease";
	}
	...
	public void execute(XmlDoc.Element args, Inputs in, Outputs out, XmlWriter w) throws Throwable {
		...
		for (String rCid : rSubjects) {
			...
			if (pathStr != null) {
				...
				doc.add("where", "xpath(daris:pssd-subject/r-subject)='" + rCid + "'");
				...
				if (subjects != null) {
					for (String sId : subjects) {
						...
						// R-Subject/nig-daris:pssd-animal-subject/pathology ->
						// Subject/nig-daris:pssd-animal-disease/disease
						doc = new XmlDocMaker("args");
						doc.add("id", sId);
						doc.push("meta");
