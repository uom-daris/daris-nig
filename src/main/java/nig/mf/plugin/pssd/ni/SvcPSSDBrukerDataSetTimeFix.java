...
public class SvcPSSDBrukerDataSetTimeFix extends PluginService {
	...
	public String description() {
		return "This one-shot service fixes daris:bruker-series/acqTime from HH:MM:SS DD-MMM-YYYY to the standard  DD-MMM-YYYY HH:MM:SS";
	}
	...
	public void execute(XmlDoc.Element args, Inputs in, Outputs out, XmlWriter w)
		...
		String query = "xpath(daris:bruker-series/acqTime) has value";
	...
	private String fixDataSetTime (ServiceExecutor executor, String id) throws Throwable {
		...
		XmlDoc.Element r2 = r.element("asset/meta/daris:bruker-series");
		if (r2==null) return null;

		List<XmlDoc.Element> els = r2.elements();
