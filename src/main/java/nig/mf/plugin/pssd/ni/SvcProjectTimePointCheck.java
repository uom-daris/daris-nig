...
public class SvcProjectTimePointCheck extends PluginService {
	...
	public String description() {
		return "Service to check Studies have self-consistent time-point meta-data. Lists only the studies that are inconsistent.  Looks at template, meta/daris:pssd-study and meta/nig-daris:pssd-time-point";
	}
	...
	private void checkStudy (String id, XmlWriter w) throws Throwable {
		...
		XmlDoc.Element pssdStudy = r.element("asset/meta/daris:pssd-study");
		XmlDoc.Element pssdTimePoint = r.element("asset/meta/nig-daris:pssd-time-point");
