...
public class SvcMetadataDataGet extends PluginService{
	...
	public void execute(XmlDoc.Element args, Inputs in, Outputs out, XmlWriter w) throws Throwable {
		...
		if(cid != null && !cid.equals(""))
		{
			...
			XmlDoc.Element pssdObj = new XmlDoc.Element("daris:pssd-object");
	 ...
	 * @param nodeName
	 */
	private void removeResultHeader(XmlDoc.Element parentdoc, XmlDoc.Element xmldoc, String nodeName) throws Throwable 
	{
		if (nodeName==null) return;
		
		List<XmlDoc.Element> els = xmldoc.elements(nodeName);
		if(els != null) {
