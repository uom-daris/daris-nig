...
proc createDocType_pssd_time_point { } {
	...
	asset.doc.type.update \
		:create true :type nig-daris:pssd-time-point \
...
proc createDocType_pssd_subject_exclusion { } {
	...
	asset.doc.type.update \
		:create true :type nig-daris:pssd-subject-exclusion \
...
proc createDocType_pssd_ImageHD_combined {} {
	...
	asset.doc.type.update \
		:create true :type nig-daris:pssd-ImageHD-combined  \
...
proc destroyPSSDDocTypesImageHD {} {
	...
	set doctypes { nig-daris:pssd-time-point nig-daris:pssd-subject-exclusion nig-daris:pssd-ImageHD-combined }
