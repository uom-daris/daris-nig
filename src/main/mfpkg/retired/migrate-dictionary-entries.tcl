...
# Document type nig-daris:pssd-ethics
if { [xvalue exists [dictionary.exists :name nig.ethics.organization]] == "true" } {
    ...
    if {$fixEthics == "1" } {
        ...
        puts "   Fixing meta-data in nig-daris:pssd-ethics documents"
        set n [xvalue number-of-assets [nig.asset.doc.element.replace :type nig-daris:pssd-ethics :path ethics-id :attribute type \
    	:old-value "AMREP AEC" \
...
# Document type nig-daris:pssd-project
if { [xvalue exists [dictionary.exists :name nig.funding.organization]] == "true" } {
    ...
    if {$fixFunding == "1" } {
        ...
        puts "   Fixing meta-data in nig-daris:pssd-project documents"
        set n [xvalue number-of-assets [nig.asset.doc.element.replace :type nig-daris:pssd-project :path funding-id  :attribute type \
    	:old-value "ARC" \
...
# Document type nig-daris:pssd-animal-modified-genetics
if { [xvalue exists [dictionary.exists :name nig.pssd.animal.genes]] == "true" } {
    ...
    if {$fixGenes == "1" } {
        ...
        # Now fix the entries in the known meta-data documents
        puts "   Fixing meta-data in nig-daris:pssd-animal-modified-genetics documents"
        set n [xvalue number-of-assets [nig.asset.doc.element.replace :type nig-daris:pssd-animal-modified-genetics \
