...
proc createDocType-pssd-EAE-perfusion {} {
       asset.doc.type.update \
           :create true :type nig-daris:pssd-EAE-perfusion \
...
proc destroyDocType-pssd-EAE-perfusion  { force } {
    ...
    if { [xvalue exists [asset.doc.type.exists :type nig-daris:pssd-EAE-perfusion]] == "true" } {
                asset.doc.type.destroy :type nig-daris:pssd-EAE-perfusion :force $force
    }
}
...
proc createDocType-pssd-EAE-stain {} {
       asset.doc.type.update \
           :create true :type nig-daris:pssd-EAE-stain \
...
proc destroyDocType-pssd-EAE-stain  { force } {
    ...
    if { [xvalue exists [asset.doc.type.exists :type nig-daris:pssd-EAE-stain]] == "true" } {
                asset.doc.type.destroy :type nig-daris:pssd-EAE-stain :force $force
    }
}
...
proc createDocType-pssd-EAE-optic-nerve-removal  {} {
        asset.doc.type.update \
           :create true :type nig-daris:pssd-EAE-optic-nerve-removal \
...
proc destroyDocType-pssd-EAE-optic-nerve-removal { force } {
    ...
    if { [xvalue exists [asset.doc.type.exists :type nig-daris:pssd-EAE-optic-nerve-removal]] == "true" } {
                asset.doc.type.destroy :type nig-daris:pssd-EAE-optic-nerve-removal :force $force
    }
}
...
proc createDocType-pssd-EAE-optic-nerve-section  {} {
        asset.doc.type.update \
           :create true :type nig-daris:pssd-EAE-optic-nerve-section   \
...
proc destroyDocType-pssd-EAE-optic-nerve-section  { force } {
    ...
    if { [xvalue exists [asset.doc.type.exists :type nig-daris:pssd-EAE-optic-nerve-section]] == "true" } {
                asset.doc.type.destroy :type nig-daris:pssd-EAE-optic-nerve-section :force $force
    }
}
...
proc createDocType-pssd-EAE-microscopy  {} {
        asset.doc.type.update \
           :create true :type nig-daris:pssd-EAE-microscopy   \
...
proc destroyDocType-pssd-EAE-microscopy  { force } {
    ...
    if { [xvalue exists [asset.doc.type.exists :type nig-daris:pssd-EAE-microscopy]] == "true" } {
                asset.doc.type.destroy :type nig-daris:pssd-EAE-microscopy :force $force
    }
}
