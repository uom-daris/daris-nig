...
#
proc create-MBIC-Human-method { { action 0 } { fillin 0 } } {
	
	set name "Human acquisitions for MBC Imaging Unit"
	set description "Multi-mode imaging acquisitions for humans"
#
