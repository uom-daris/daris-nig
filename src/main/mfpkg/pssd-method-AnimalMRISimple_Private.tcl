...
proc createMethod_animal_mri_simple_private { { action 0 } {fillin 0 } } {
	...
	set args "${margs} \
	    ...
	    :subject < \
	    	:project < \
			 ...
			 > \
		   	 :private <\
		    		:metadata < :definition -requirement mandatory nig-daris:pssd-subject :value < :type constant(animal) > > \
